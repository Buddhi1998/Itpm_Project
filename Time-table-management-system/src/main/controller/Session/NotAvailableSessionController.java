...
public class NotAvailableSessionController implements Initializable {
    ...
    @FXML
    public TableView<AllNotAvailableSession> tblNotAvailableSessions;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        this.getAllNotAvailableSessions();
    }
    ...
    public void getAllNotAvailableSessions() {

        try {
            SessionService sessionService = new SessionServiceImpl();
            ArrayList<AllNotAvailableSession> notAvailableSessions = sessionService.getAllNotAvailableSessions();
            tblNotAvailableSessions.setItems(FXCollections.observableArrayList(notAvailableSessions));
        } catch (Exception e) {
            log.log(Level.SEVERE, e.getMessage());
        }
    }
    ...
    public void setTableProperties() {
        tblNotAvailableSessions.getSelectionModel().getTableView().getItems().clear();
        tblNotAvailableSessions.getColumns().get(0).setCellValueFactory(new PropertyValueFactory<>("subjectId"));
        tblNotAvailableSessions.getColumns().get(1).setCellValueFactory(new PropertyValueFactory<>("notAvailableSessionId"));
        tblNotAvailableSessions.getColumns().get(2).setCellValueFactory(new PropertyValueFactory<>("groupId"));
        tblNotAvailableSessions.getColumns().get(3).setCellValueFactory(new PropertyValueFactory<>("subGroupId"));
        tblNotAvailableSessions.getColumns().get(4).setCellValueFactory(new PropertyValueFactory<>("day"));
        tblNotAvailableSessions.getColumns().get(5).setCellValueFactory(new PropertyValueFactory<>("toTime"));
        tblNotAvailableSessions.getColumns().get(6).setCellValueFactory(new PropertyValueFactory<>("fromTime"));
    }
}
